...
#Render Section
bpy.data.scenes['Scene'].render.filepath = '/var/www/html/render-testing/asd.png'
bpy.ops.render.render( write_still=True )
#file rendered: /var/www/html/render-testing/asd.png
#CREATED: /var/www/html/render-testing/asd.py