...
#Render Section
bpy.data.scenes['Scene'].render.filepath = '/var/www/html/render-testing/epic.png'
bpy.ops.render.render( write_still=True )
#file rendered: /var/www/html/render-testing/epic.png
#CREATED: /var/www/html/render-testing/epic.py