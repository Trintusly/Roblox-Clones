...
#Render Section
bpy.data.scenes['Scene'].render.filepath = '/var/www/html/render-testing/aaaabaa.png'
bpy.ops.render.render( write_still=True )
#file rendered: /var/www/html/render-testing/aaaabaa.png
#CREATED: /var/www/html/render-testing/aaaabaa.py