...
if(!$bop->logged_in())
{
	...
	$user = $bop->local_info();
	if(!$bop->isVerified($user->id) && !isset($ignore))
	{
...
<script>
  (adsbygoogle = window.adsbygoogle || []).push({
    google_ad_client: "ca-pub-9208320000277641",
	...
	<body>
      ...
      $pages1 = [
          ...
          "Settings" => "/account/",
			...
			$pages1["left"][$friendsText] = "/friends/";
      ...
      <div class="container">
				<ul style="margin-bottom:0px;padding:0px;padding-top:5px;">
					<div class="grid">
						<?php
			...
			?>
			<div class="container">
				<ul style="margin-bottom:0px;padding:0px;font-size:15px">
					<div class="grid">
						<?php
						foreach ($pages1 as $class => $links) {
						?>
						<div class="<?=$class?>">
						<?php
							foreach ($links as $name => $link) {
