...
<div class="card" style="width: 25rem;">
  ...
  <div class="card-body">
    ...
    <strong>
    <p class="card-text">Verify your Tetrimus account for access to more stuff.</p>
    <form action="" method="post">
    <input type="submit" value="Send Email Verification" />
...
{
    $to      = '$user->email';
    $subject = 'Verififcation';
    $message = 'Work in Progress';
    $headers = 'From: no-reply@tetrimus.xyz' . "\r\n" .
        'Reply-To: $user->email' . "\r\n" .
...
?>
<hl>
    <a href="mailto:<?php echo"$user->email"?>?Subject=Work%20In%20Progress" target="_top"
    <button class="btn btn-primary" type="button">Resend Verification Code</button></a>
    <br>
    <hr>
    <button class="btn btn-success" type="button">Request Staff Verify</button>'
