...
if($loggedIn){
    if ($user->id != $fetchuser->id) {
        if($displayAdd == true) {
            ...
            echo '
               <form action="#" method="POST">
                  <button class="btn grey" name="b-baka dont touch this">Friend Request Pending</button>
               </form>
            ';  
        }else{
...
if($fetchuser->membership == "platinum"){
    echo"<img src='http://tetrimus.rf.gd/storage/badges/platinum.png' style='width:100px;height:100px;' data-toggle='tooltip' data-placement='top' title='This badge is given to all users who have a platinum membership.'>";
}
...
if($fetchuser->membership =="bronze"){
    echo"<img src='http://tetrimus.rf.gd/storage/badges/bonze.png' style='width:100px;height:100px;' data-toggle='tooltip' data-placement='top' title='This badge is given to all users who have a basic membership.'>";
}
