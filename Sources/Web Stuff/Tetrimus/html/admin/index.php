...
<center><h3>Realms</h3>
There are <b>0</b> realm reports.</center>
<hr>
<center><h3>Users</h3>There are <b>0</b> realm reports.</center>
</div>
...
<form action="" method="POST">
      ...
      <input class='form-control' type="text" name="id" placeholder="User ID">
      <div style="height: 10px;"></div>
      <input class='form-control' type="text" name="power" placeholder="Power Level">
      <div style="height: 10px;"></div>
      <input class="btn btn-success" name="grant" type="submit" value="Grant">
      </form>
