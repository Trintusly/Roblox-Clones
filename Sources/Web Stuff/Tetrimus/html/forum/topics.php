...
<div style="padding:10px;border-radius:5px;background-color:#007bff;border:1px solid #007bff;color:#fff;">
...
$i = 1;
	...
	$findlastposter = $conn->query("SELECT * FROM `users` WHERE `id`='".$output2['lastposter']."'");
		...
		if($output2['views'] >= 200 && $output2['replies'] >= 10){
			...
			echo "<img src='https://cdn.discordapp.com/attachments/486311910162169858/493535548053520400/file4.png' style='height: 25px;width: 25px;'>&nbsp;";
		}
