...
<title>Amelia Pedophile Simulator | Tetrimus</title>
<meta name="viewport" content="width=device-width, initial-scale=1">
...
<div class="alert alert-danger" role="alert">
  This game has been deleted by moderators.
</div>
</center>
<?php
/*
...
<img src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcSk-PlI5c5NojAeu1FZ_5Co2uMU8_eGiM_gXKYOkZ0Jgi5fuv90" alt="" style="width: 100%;max-width: 483px;max-height: 262px;margin-left: -7rem;">
</div>
<div style="margin-left: -3rem;" class="col-lg-5 my-2">
<h5>Deleted by Moderators.</h5>
<h6>Description Purged.</h6>
Created by: <a href="https://www.tetrimus.xyz/profile.php?id=21">Plainoldbread</a>
<br><br><a style="color:green;">0 playing</a>
<br><input style="margin-top: 4rem;" class="btn btn-primary  btn-block btn-lg" type="button" value="Play" onclick="playGameByType("client")"="">
<br>
<button class="btn btn-danger" onclick="UnfinishedCode()" name="leave" type="submit">Delete</button>
</div>
</div>
<hr>
</div>
...
<div style="font-size:20px;">October 20th, 2018</div>
<div style="color:#999;font-size:14px;">Created</div>
</div>
<div class="col s12 m12 l3 center-align">
<div style="font-size:20px;">October 21st, 2018</div>
<div style="color:#999;font-size:14px;">Last Updated</div>
</div>
<div class="col s12 m12 l3 center-align">
<div style="font-size:20px;">100000</div>
