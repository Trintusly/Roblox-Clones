...
<h6>Testing Purposes</h6>
Created by: <a href="https://www.tetrimus.xyz/profile.php?id=1">South</a>

<br>
<div id="playRealm">
<input style="margin-top: 2rem;" class="btn btn-primary  btn-block btn-lg" type="button" value="Play" onclick="playRealmByID("1,client-testing")></div>
<div id="editRealm">
<input style="margin-top: 1rem;" class="btn btn-secondary  btn-block btn-lg" type="button" value="Edit in Workshop" onclick="editRealmByName("1,client-testing")>
</div>
</div>
</div>
<hr>
...
<div style="font-size:20px;">September 17th, 2018</div>
