...
if($user->Hat != "none") {
$importHat = '
hatpath = "/var/render/models/hats/'.$user->Hat.'.obj"
...
if($user->Gear != "none") {
$importGear = '
gearpath = "/var/render/models/gear/'.$user->Gear.'.obj"
...
$addMiddle = '
LeftArmImg = bpy.data.images.load(filepath="/var/www/html/storage/store_storage/shirts/blackdiamond.png")
...
RightArmImg = bpy.data.images.load(filepath="/var/www/html/storage/store_storage/shirts/blackdiamond.png")
...
TorsoImg = bpy.data.images.load(filepath="/var/www/html/storage/store_storage/shirts/blackdiamond.png")
