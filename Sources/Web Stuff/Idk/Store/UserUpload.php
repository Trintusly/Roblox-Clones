...
Price</td> <td><input type='text' name='price'></td></tr><tr><td>
 ...
 <font color='black' style='font-size:10pt;'>Anything uploaded that are not the following will be declined: Backgrounds, Shoes, Shirts, Pants. If you upload content from another website that owns the rights to such content, the content will be removed from BrickPlanet and your account will be terminated.</font>
 </form> 
 <?php 
