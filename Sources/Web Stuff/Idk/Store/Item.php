		...
		<tr>
			<td>
				...
				<table width='100%'>
					<tr>
						<td width='50%'>
							<b style='text-transform:uppercase;font-size:8pt;'>BrickPlanet $gI->Type</b>
						</td>
						<td>
									...
									<tr>
										...
										<td width='200'>
											...
											if ($tG < 5) {
												...
												echo "</form><form action='Item.php?ID=".$ID."&SaleID=".$getS->ID."' method='POST'><input type='submit' name='PurchaseSale' value='Purchase' disabled='disabled'  id='buttonsmall' title='You already own at least 5 of this item'></form>";
