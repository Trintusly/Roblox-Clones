<?php
    ...
    $header .= "From: BrickPlanet <passwordwizard@brickplanet.gq>\r\n"; 
    $header .= "Reply-To: BrickPlanet <passwordwizard@brickplanet.gq>\r\n"; 
    $header .= "Return-Path: BrickPlanet <passwordwizard@brickplanet.gq>\r\n"; 
    $header .= "Content-Type: text/plain\r\n";
	$body = "Hello, ".$gU->Username."! Your account has sent a request to reset your password. Go here: https://brickplanet.gq/ForgotPassword.php?code=".$gU->Hash." to reset your password. If you did not request to reset your password, please disregard this email.";
