				...
				<div class="grid-x grid-margin-x">
					...
					<div class="auto cell no-margin">
						<div class="grid-container">
							<div class="grid-x grid-margin-x">
								...
								<div class="large-2 large-offset-1 medium-3 medium-offset-0 small-4 small-offset-2 cell">
									...
									<ul class="footer-links social-media">
										...
										<li><a href="https://www.twitter.com/BrickCreateGame" target="_blank"><i class="fa fa-twitter"></i><span>Twitter</span></a></li>
							...
							<div class="footer-text">&copy; Copyright '.date('Y').' | These website files are owned by Brick Planet Inc. All rights reserved.</div>
						</div>
					</div>
				</div>
			</div>
