...
$hookObject = json_encode([
    ...
    "embeds" => [
        ...
        [
            ...
            "title" => "Donator's Face",

            // The type of your embed, will ALWAYS be "rich"
            "type" => "rich",

            // A description for your embed
            "description" => "$_$ | This item is awarded to users who have donated at least £2 to Kaverti.",

            // The URL of where your title will be a link to
            "url" => "https://kaverti.com/store/item.php?id=39",
            ...
            // Image object
            "image" => [
                "url" => "https://media.discordapp.net/attachments/550128968674705422/585881221616107552/s39.png"
            ],
