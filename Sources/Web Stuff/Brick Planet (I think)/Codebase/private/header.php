	...
	<?php
					...
					<div class="shrink cell">
						<ul class="menu align-middle">
							...
							if (!$AUTH) {
								...
								<li class="menu-link">
									<a title="'.number_format($myU->CurrencyCredits).' Credits" href="'.$serverName.'/">
								...
								<li class="menu-link">
									<a title="'.number_format($myU->CurrencyCoins).' Bits" href="'.$serverName.'/">
			...
			<div id="user-dropdown-all" data-toggler data-animate="fade-in fade-out" style="display:none;z-index: 100;" class="fast">
				...
				<div class="user-dropdown" id="user-dropdown">
					<div class="dropdown-header">
						<div class="grid-x align-middle grid-margin-x">
							<div class="shrink cell no-margin">
								<div class="avatar-preview-thumbnail" style="background-image:url(https://cdn.brickcreate.com/975289c5-1c08-463c-bdf5-0b49d35c933b.png);background-size:cover;"></div>
							</div>
							<div class="auto cell">
		...
		<ul>
			...
			if ($AUTH) {
				...
				<li><a href="'.$serverName.'/Nitro/"'; if ($page == 'Nitro') { $MobileDesktopHTML .= ' class="active"'; } $MobileDesktopHTML .= '><i class="material-icons">star</i><span>Nitro Membership</span></a></li>
					...
					if ($AUTH && $myU->AccountVerified == 0) {
						...
						<div class="site-announcement">
							<div class="grid-x align-middle grid-margin-x">
								...
								<div class="auto cell">
								This website is only for the purpose of testing and having fun, These website files are owned by Brick Planet Inc. | You can also join our official discord server by clicking <a href="https://discord.gg/FMhpNNf">Here</a>
								</div>
								<div class="shrink cell right">
									<i class="material-icons">error_outline</i>
								</div>
					...
					if ($DisplayAds == true) {
						...
						<div class="advert-container-horizontal">
							...
							<ins class="adsbygoogle"
								 style="display:block"
								 data-ad-client="ca-pub-7534415662580995"
								 data-ad-slot="3138731321"
