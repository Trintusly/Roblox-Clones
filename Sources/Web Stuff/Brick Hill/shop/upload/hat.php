				...
				if($imgSize < 2097152) {
					if(isset($_POST['name'])) {
						if(isset($_POST['bits']) or isset($_POST['bucks'])) {
							...
							move_uploaded_file($imgTmp,"../../shop_storage/assests/hats/".shopItemHash($itemID).".png");
							move_uploaded_file($objTmp,"../../shop_storage/assests/hats/".shopItemHash($itemID).".obj");
