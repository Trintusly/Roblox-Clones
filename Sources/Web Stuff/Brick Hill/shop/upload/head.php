				...
				if(1 == 1) {
					if(isset($_POST['name'])) {
						if(isset($_POST['bits']) or isset($_POST['bucks'])) {
							...
							$newSQL = "INSERT INTO `shop_items` (`id`,`owner_id`,`name`,`description`,`bucks`,`bits`,`type`,`date`,`last_updated`,`offsale`,`collectible`,`collectable-edition`,`collectible_q`,`zoom`,`approved`) VALUES (NULL,'$ownerID','$name','$desc','$bucks','$bits','hat','$today','$today','no','$collectible','$collectible','$stock',NULL,'yes')";
...
<!DOCTYPE html>
	<head>
		<title>Upload Head - Brick Hill</title>
	</head>
	<body>
		<div id="body">
			<div id="box">
